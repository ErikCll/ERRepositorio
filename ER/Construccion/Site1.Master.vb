...
Public Class Site1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Dim query As String = "SELECT Nivel2 FROM Cat_Menu_V3 WHERE id_requisito BETWEEN 24 AND 90 AND Activado IS NULL GROUP BY Nivel2,Nivel2_no ORDER BY Nivel2_no ASC"
            obj.Llenar(query)
    ...
    Protected Sub Tablero_Click(sender As Object, e As EventArgs)
        ...
        If lblIdInstalacion.Text = -1 Then
            ...
            ScriptManager.RegisterClientScriptBlock(litControl, litControl.GetType(), "script", txtJS, False)
        Else
            Response.Redirect("TableroC.aspx")
    ...
    Protected Sub AdminTopListView_ItemDataBound(sender As Object, e As ListViewItemEventArgs)
        ...
        Dim query4 As String = "SELECT id_requisito, Requisito FROM Cat_Menu_V3 WHERE Nivel2 = '" + name.Text + "' AND Nivel3 IS NULL AND Activado IS NULL"
        obj.Llenar(query4)
        ...
        Dim query As String = "SELECT Nivel3 FROM Cat_Menu_V3 WHERE Nivel2 = '" + name.Text + "' AND NIVEL3 IS NOT NULL AND Activado IS NULL GROUP BY Nivel3,Nivel3_no ORDER BY Nivel3_no ASC"
        ...
        For Each item In childMenu.Items
            ...
            Dim query5 As String = "SELECT id_requisito,Requisito FROM Cat_Menu_V3 WHERE Nivel2 = '" + name.Text + "' AND Nivel3='" + name2.Text + "' AND Activado IS NULL"
            obj.Llenar(query5)
            ...
            For Each item3 In recommendedProducts3.Items
                ...
                Dim query3 As String = "SELECT id_requisito,Requisito FROM Cat_Menu_V3 WHERE Nivel2 = '" + name.Text + "' AND Nivel3='" + name2.Text + "' AND Activado IS NULL"
                obj.Llenar(query3)
    ...
    Protected Sub Requisito1_Click(sender As Object, e As EventArgs)
        ...
        Else
            ...
            Response.Redirect("RequisitoC.aspx?id=" + encodedString + "&req=" + s)
