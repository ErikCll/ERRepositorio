<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Operacion/Site2.Master" CodeBehind="Evidencia.aspx.vb" Inherits="ER.Evidencia1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <label class="font-weight-bold">Requisito: </label><asp:Label runat="server" ID="lblRequisito"></asp:Label>
       <br />
                ...
                <div class="box-body" id="DivInsertar" runat="server" >
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-md-3 col-lg-3">
                                <div class="form-group">
                                    <label class="font-weight-bold">Fecha de la evidencia:</label>
...
<%--       var f = new Date();
        var fechahoy=  f.getDate() + "-"+ f.getMonth()+ "-" +f.getFullYear();
