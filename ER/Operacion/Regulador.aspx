<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Operacion/Site2.Master" CodeBehind="Regulador.aspx.vb" Inherits="ER.Regulador" %>
       ...
       <asp:UpdatePanel UpdateMode="Conditional" runat="server" ID="Update1">
                ...
                <div class="box-body" id="DivInsertar">
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-md-4 col-lg-4">
                            <div class="form-group">
                                <label class="font-weight-bold">Nombre corto:</label>

                               <asp:TextBox class="form-control " ID="txt_ReguladorCorto" runat="server" MaxLength="80" onkeypress="return AllowAlphabet(event)">
                   
                                </asp:TextBox>
                             
                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="txt_ReguladorCorto"
                                    ErrorMessage="Nombre de regulador corto requerido." ForeColor="Red" ValidationGroup="btnGuardar"></asp:RequiredFieldValidator>
                 ...
                 PageSize="10"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Nombre">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblCorto" runat="server" Text='<%# Eval("Nombre_corto") %>'></asp:Label>
                                <asp:TextBox ID="txtEditCorto" runat="server" BackColor="#ffffbb" BorderColor="#ffffbb" class="form-control" Width="200px"
                                    Text='<%# Eval("Nombre_corto") %>' Visible="false" onkeypress="return AllowAlphabet(event)" MaxLength="80"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
  ...
  var div = $('#DivInsertar');
              ...
              function limpiar() {
                  document.getElementById("<%= txt_Regulador.ClientID %>").value = "";
                              document.getElementById("<%= txt_ReguladorCorto.ClientID %>").value = "";
